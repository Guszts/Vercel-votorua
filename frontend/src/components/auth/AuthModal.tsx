...
export default function AuthModal({
  ...
  const submit = async (e: FormEvent) => {
    ...
    else if (mode === "signup") setInfo("Conta criada! Se o email exigir confirmação, clique no link recebido e depois faça login.");
    else onClose();
  };
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="bg-white w-full sm:max-w-md rounded-t-[32px] sm:rounded-[32px] p-7 pb-10 shadow-2xl relative max-h-[92vh] overflow-y-auto"
          >
            <button
              onClick={onClose}
            ...
            <div className="mb-6">
              ...
              <p className="text-stone-500 font-medium mt-1 text-sm">
                {mode === "login" ? "Entre com Google ou email para continuar." : "Cadastre-se com email. Leva 10 segundos."}
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 my-5">
              ...
              <span className="text-xs font-bold text-stone-400 uppercase tracking-widest">ou email</span>
              <div className="flex-1 h-px bg-stone-200" />
            </div>
            ...
            <form onSubmit={submit} className="space-y-3">
              {mode === "signup" && (
                <label className="block">
                  ...
                  <div className="relative">
                    ...
                    <input
                      data-testid="auth-name" type="text" value={fullName}
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <input
                    data-testid="auth-email" type="email" required value={email}
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <input
                    data-testid="auth-password" type="password" required minLength={6} value={password}
              ...
              {error && (<p data-testid="auth-error" className="text-red-600 text-sm font-bold">{error}</p>)}
              {info && (<p data-testid="auth-info" className="text-green-700 text-sm font-bold">{info}</p>)}

              <button
                data-testid="auth-submit" disabled={loading} type="submit"
